...
public class BoardMgr {
	...
	private static final String SAVEFOLDER1 = "C:\\Users\\CS2-27\\eclipse-workspace\\웹프+디비\\WebContent\\images"; // 실제 파일 저장 경로
	...
	public void deleteBoard1(int num) { // 게시물 삭제
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		ResultSet rs = null;
	...
	public void downLoad(HttpServletRequest req, HttpServletResponse res, JspWriter out, PageContext pageContext) {
		try { // 요청객체인 req에서 다운로드 파일명을 문자열로 리턴 받는다.
			String filename = req.getParameter("filename"); // 저장된 경로와 다운로드 파일명을 합쳐서 File 객체를 생성한다.
			File file = new File(UtilMgr.con(SAVEFOLDER + File.separator + filename)); // 파일의 용량 크기 만큼 byte 배열을 선언한다.
			byte b[] = new byte[(int) file.length()]; // 응답 객체 res 헤더필드에 Accept-Ranges에 bytes 단위로 설정한다.
			res.setHeader("Accept-Ran//ges", "bytes"); // 요청객체인 req에서 클라이언트의 User-Agent 정보를 리턴 받는다.
			String strClient = req.getHeader("User-Agent"); // 브라우저의 버전과 정보를 구분해서 각각 res 헤더필드와 contentType을 설정한다.
			...
			if (file.isFile()) { // 파일 존재 여부에 따라 스트링 방식으로 브라우저로 파일을 전송한다.
	...
	public void updateBoard(BoardBean bean) { // 게시물 수정
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	public void updateBoard1(BoardBean bean) { // 게시물 수정
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	public void replyBoard(BoardBean bean) { // 게시물 답변
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public void replyBoard1(BoardBean bean) { // 게시물 답변
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public void deleteBoard2(int num) { // 게시물 삭제
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		ResultSet rs = null;
	...
	public void updateBoard2(BoardBean bean) { // 게시물 수정
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	public void replyBoard2(BoardBean bean) { // 게시물 답변
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	public void deleteBoard3(int num) { // 게시물 삭제
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		ResultSet rs = null;
	...
	public void updateBoard3(BoardBean bean) { // 게시물 수정
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = null;
		try {
	...
	public void replyBoard3(BoardBean bean) { // 게시물 답변
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
