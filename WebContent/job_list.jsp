...
<%
	...
	totalRecord = bMgr.getTotalCount2(keyField, keyWord);
...
<script type="text/javascript">
	...
	function list() {
		document.listFrm.action = "job_list";
...
<%
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				%>				<tr>
				<td>	<input type="button" onclick="location.href='j_post.jsp'" value="글쓰기"> <td>
				</tr>
			</table>
 ...
 %></a></li>
	...
	<form name="searchFrm" method="post" action="job_list.jsp">
