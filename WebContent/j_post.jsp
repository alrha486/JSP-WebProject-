...
<%
	...
	<div class="container">
		<div class="row">
			<form name="postFrm" method="post" action="j_postProc.jsp"
				enctype="multipart/form-data">  <!-- 게시 글 입력 폼 -->
				<table class="table table-striped"
					...
					<tr>
						...
						<!-- hidden으로 id와 passwd도 proc 폼으로 보내기 -->
					<tr>
						<td colspan="2">
							<input type="button" value=" 등록 " onclick="Check()"> 
							<input type="reset" value=" 다시쓰기 "> 
							<input type="button" value=" 리스트 " onclick="location.href='job_list.jsp' "></td>
					</tr>
				</table>
