...
<%
	...
	totalRecord = bMgr.getTotalCount1(keyField, keyWord);
...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "notice_list";
...
<%=pagePerBlock%>
	* (value - 1) + 1;
	...
	function read(idx) {
		...
		document.readFrm.action = "read1.jsp";
		document.readFrm.submit();
	}
	function check() {
...
<body>
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<%
					vlist = bMgr.getBoardList1(keyField, keyWord, start, end);
				...
				<tr>
					<td><input type="button" onclick="location.href='n_post.jsp'"
						value="글쓰기">
					<td>
				</tr>
				<%}else if(!userID.equals("운영자") || userID.equals("")){ %>
 ...
 %></a></li>
	...
	<form name="searchFrm" method="post" action="notice_list.jsp">
