...
<%
	...
	totalRecord = bMgr.getTotalCount3(keyField, keyWord);
...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "public_list";
...
<%=pagePerBlock%>
	* (value - 1) + 1;
	...
	function read(idx) {
		...
		document.readFrm.action = "read3.jsp";
		document.readFrm.submit();
	}
	function check() {
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<%
					vlist = bMgr.getBoardList3(keyField, keyWord, start, end);
...
<input type="button" onclick="location.href='p_post.jsp'"
						value="글쓰기">
		</div>
	</div>
...
<table class="table table-striped"
				style="text-align: center; border: 1px solid #dddddd">
	<form name="searchFrm" method="post" action="public_list.jsp">
