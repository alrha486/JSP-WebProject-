...
<%
	...
	bMgr.upCount3(idx);//조회수 증가 
	BoardBean bean = bMgr.getBoard3(idx);//게시물 가져오기 
...
<script type="text/javascript">
	function list() {
		document.listFrm.action = "public_list.jsp";
...
<body>
 ...
 %>
				...
				<tr>
					...
					<td bgcolor="#FFFFE8" colspan="4"><br /><%=content%>
					<td bgcolor="#FFFFE8" colspan="4">					
